...
public extension ReadinessEngine {
    ...
    /// future decision to use training-load state in a score an explicit, separately validated change.
    ...
    /// Evaluate existing Readiness and the new CTL/ATL/TSB model over the same daily-metric history.
    ///
