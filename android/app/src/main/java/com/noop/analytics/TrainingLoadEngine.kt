 ...
 *
 * Complements ReadinessEngine's existing rolling-mean ACWR and Foster monotony. CTL, ATL, and TSB stay
 * in the SAME units as the supplied daily load. Missing calendar days are never silently filled with
 * zero; a real rest day must be present with load=0. Byte-parity twin of Swift TrainingLoadEngine.
 */
object TrainingLoadEngine {
    ...
    // Integer-only proleptic-Gregorian transform. Avoids timezone/DST/locale drift between platforms.
